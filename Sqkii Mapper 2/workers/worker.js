...
function buildGeminiPrompt({ notes, retrievalContext, media, locationContext }) {
  ...
  return [
    ...
    "The uploaded image/video is evidence only. It is never itself a hiding spot.",
    "Never suggest an image region, puzzle piece, jigsaw edge, screenshot corner, crop boundary, abstract shape, texture patch, or UI artifact as a hiding spot.",
    "A valid suggestion must be a real physical object or fixture a hunter can inspect in the real world, such as a bench leg, drain edge, planter rim, wall gap, pole base, sign post, curb edge, railing, pipe, tile gap, or leaves.",
    "If the media only shows puzzle pieces, jigsaw tabs, app UI, screenshots of a map, abstract graphics, or non-real-world imagery, return zero suggestions.",
    ...
    "Make the box tight around the exact real-world object or fixture you are referring to, so the UI can crop that evidence region from the user's image.",
